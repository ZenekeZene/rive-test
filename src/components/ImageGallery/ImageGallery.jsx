...
const PLACEHOLDER_IMAGES = [
  { id: 1, url: "/artworks/portrait/C40sZ2cNDaB_2.jpg", title: "Portrait", description: "Digital portrait illustration", size: "tall", quipKey: "artQuipPortrait", details: [
  ...
  { id: 2, url: "/artworks/gorila/C4_fevFtWmV_1.jpg", title: "Gorila", description: "Album cover illustration for Lindano", size: "wide", quipKey: "artQuipGorila", details: [
  ...
  { id: 3, url: "/artworks/space/DJPT45bKBvb_1.jpg", title: "Space", description: "Sci-fi comic illustration", size: "square", quipKey: "artQuipSpace", details: [
  ...
  { id: 6, url: "/artworks/Deus/CZfXegqgSEM_1.jpg", title: "Deus", description: "Limited palette illustration for @exquisiteworkers", size: "square", quipKey: "artQuipDeus", details: [
  ...
  { id: 7, url: "/artworks/Demonios/CY6Xno4tOtH_1.jpg", title: "Demonios", description: "Color study in Procreate", size: "tall", quipKey: "artQuipDemonios", details: [
  ...
  { id: 8, url: "/artworks/Chelines/CYd7sDEgEpp_1.jpg", title: "Chelines", description: "Van Gogh reimagined", size: "wide", quipKey: "artQuipChelines", details: [
  ...
  { id: 9, url: "/artworks/Mucho/CZxJ_xiAk0b_1.jpg", title: "Mucho", description: "Fanzine secreto #2", size: "square", quipKey: "artQuipMucho", details: [
  ...
  { id: 10, url: "/artworks/Encuentra en el bloque/CAtApYFCVIB_1.jpg", title: "Encuentra en el bloque", description: "Hidden details illustration", size: "tall", quipKey: "artQuipEncuentra", details: [
  ...
  { id: 11, url: "/artworks/Klimt/B7DwGBPi-_4_1.jpg", title: "Klimt", description: "Tribute to Las tres edades de la mujer", size: "tall", quipKey: "artQuipKlimt", details: [
  ...
  { id: 12, url: "/artworks/Moebius/BtjkMAtgwfu_1.jpg", title: "Moebius", description: "Space and imagination tribute", size: "square", quipKey: "artQuipMoebius", details: [
  ...
  { id: 13, url: "/artworks/Noche/B2MRbo4Ctqq_2.mp4", title: "Noche", description: "The darkest hour", size: "wide", quipKey: "artQuipNoche", details: [
  ...
  { id: 14, url: "/artworks/Miedo y asco en el Guggen/CRjNyLUAbHI_1.jpg", title: "Miedo y asco en las Vegas", description: "Fear and loathing inspired illustration", size: "tall", quipKey: "artQuipMiedo", details: [
  ...
  { id: 15, url: "/artworks/Smoke/CQWhtLfg-mI_1.jpg", title: "Smoke", description: "Beat tape cover for @hawaiiano_kid", size: "square", quipKey: "artQuipSmoke", details: [
  ...
  { id: 16, url: "/artworks/covid19/CX35eTEt0qt_1.jpg", title: "Covid 19", description: "Pandemic character illustration", size: "wide", quipKey: "artQuipCovid", details: [
  ...
  { id: 17, url: "/artworks/Gernika/CcsT0T5taBo_1.jpg", title: "Gernika", description: "Colección \"Sorry not sorry, Picasso\"", size: "tall", quipKey: "artQuipGernika", details: [
    "/artworks/Gernika/CROu-s9AbKD_1.jpg",
    "/artworks/Gernika/CRR65CGgpO8_1.jpg",
  ], about: "Colección \"Sorry not sorry, Picasso\"." },
  { id: 18, url: "/artworks/homenaje a bones/CQ6wNzJA_9Z_1.jpg", title: "Homenaje a Bones", description: "Clay sculpture tribute", size: "square", quipKey: "artQuipBones", details: [
