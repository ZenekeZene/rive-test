...
const layerList = [
  ...
  {
    ...baseConfig,
    src: './images/spider-shadow-2.png',
    zIndex: -3,
    mode: 'isMoving',
    opacity: 1,
    blend: 'multiply',
  ...
  {
    ...baseConfig,
    src: './images/shadow-girl.png',
    zIndex: -2,
    mode: 'no-moving',
  },
  {
    ...baseConfig,
    src: './images/spider-shadow.png',
    zIndex: -1,
    mode: 'isMoving',
    opacity: 1,
  },
  ...
  {
    ...baseConfig,
    src: './images/girl-shadow-red.png',
    mode: 'isMoving',
    zIndex: 2.9,
  },
  {
